---
tags: [library, reviewer, karri, quotes]
type: source
status: raw
project: nexus
harvested: 2026-05-13
harvested_by: claude-opus-4-7-1m
period_covered: 2026-05-08 → 2026-05-13
sibling: 00-claude-inbox/nexus/2026-05-13/round2/17_karri_instruction_harvest.md
interpretation_doc: 00-claude-inbox/nexus/2026-05-13/round2/16_karri_proposal_corpus.md
---

# Karri quotes corpus — primary source

Direct quotes only, no interpretation. Interpretation lives in sibling `16_karri_proposal_corpus.md`. This file is the raw harvest from code comments, commit messages, proposal-doc bodies, memory files, and Obsidian notes — everything beyond the boilerplate `Reviewer: Karri` line.
